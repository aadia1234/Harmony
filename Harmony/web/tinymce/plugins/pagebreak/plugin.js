...
(function () {
    ...
    const getPlaceholderHtml = shouldSplitBlock => {
        const style = 'cursor: default; display: block; height: 10px; margin-top: 15px; width: 100%; background-color: rgb(236 237 242); padding-right: 12.2rem; box-shadow: inset 0px 8px 8px -10px #ccc, inset 0px -8px 8px -10px #ccc; margin-left: -6.1rem; border: none;';
      const html = `<img style="${ style }" src="${ global.transparentSrc }" class="${ pageBreakClass }" data-mce-resize="false" data-mce-placeholder/>`;
